...
public:
  ...
  virtual void modify(
    ...
    const typename Tempus::StepperNewmarkExplicitAFormAppAction<double>::ACTION_LOCATION actLoc)
  {
    switch(actLoc) {
...
public:
  ...
  StepperNewmarkExplicitAFormModifierXTest()
    : testX_BEGIN_STEP(false), testX_BEFORE_EXPLICIT_EVAL(false),
      testX_AFTER_EXPLICIT_EVAL(false), testX_END_STEP(false),
  ...
  virtual void modify(
    ...
    const typename Tempus::StepperNewmarkExplicitAFormModifierXBase<double>::MODIFIER_TYPE modType)
  {
    switch(modType) {
      ...
      case StepperNewmarkExplicitAFormModifierXBase<double>::X_BEFORE_EXPLICIT_EVAL:
      {
      ...
      case StepperNewmarkExplicitAFormModifierXBase<double>::X_AFTER_EXPLICIT_EVAL:
      {
